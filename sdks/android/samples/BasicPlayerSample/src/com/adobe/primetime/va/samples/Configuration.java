...
public class Configuration {
    ...
    public static final String HEARTBEAT_JOB_ID          = "test-job-id";
    public static final String HEARTBEAT_PUBLISHER       = "test-publisher"; // To be replaced with: "test-publisher"
